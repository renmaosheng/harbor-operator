...
func (r *Reconciler) UpdateAppliedStatus(ctx context.Context, result *ctrl.Result, notary *goharborv1alpha2.NotaryServer) error {
...
func (r *Reconciler) UpdateReadyStatus(ctx context.Context, result *ctrl.Result, notary *goharborv1alpha2.NotaryServer) error {
